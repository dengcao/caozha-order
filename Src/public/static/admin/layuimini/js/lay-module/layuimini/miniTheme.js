        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="https://gitee.com/caozha/caozha-order" target="_blank"><i class="layui-icon layui-icon-read" style="font-size: 19px;"></i> 程序框架：caozha-order</a>\n' +
