    ...
    public function index()
    {
        ...
        if ($web_config->isEmpty()) {
            ...
            if(!isset($web_config_data["tips_order_post_type"])){
                $web_config_data["tips_order_post_type"]=3;
                $web_config_data["email_smtp_config"]="smtp.163.com||465||ssl||UTF-8||发件人姓名||账号@163.com||密码（授权码）||账号@163.com";
                $web_config_data["email_smtp_to"]="账户@163.com";
                $web_config_data["email_smtp_addcc"]="";
                $web_config_data["email_smtp_addbcc"]="";
                $web_config_data["email_smtp_subject"]="收到新订单提醒";
                $web_config_data["email_smtp_content"]="有客户提交了新订单，请您及时处理。<br><br>
订单内容如下：<br>
客户姓名：{@realname}<br>
订购产品：{@pro_name}<br>
订购选项：{@pro_options}<br>
